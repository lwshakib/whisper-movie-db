/**
 * Import custom components for navigation and API configuration for fetching trending movies.
 */
...
/**
 * TrendingMovies screen component.
 * Displays a paginated grid of movies that are currently trending.
 */
